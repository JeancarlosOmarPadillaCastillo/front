...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {path:"historial", component: ProgramPrincipalComponent},
      {path:"program-form", component: ProgramFormComponent},
      {path:"activitiesTennager", component: UnitprogramPrincipalComponent},
      {path:"activitiesTennager-form", component: UnitprogramFormComponent},
